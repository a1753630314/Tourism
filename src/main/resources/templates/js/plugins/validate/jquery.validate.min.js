...
!function (a) {
    ...
    a.extend(a.validator.messages, {
        ...
        rangelength: a.validator.format("请输入长度在 {0} 到 {1} 之间的字符"),
...
$('input').focus(function () {
    $(this).parent().find('.info-tips').css({visibility: 'inherit'})
});
$('input').blur(function () {
    $(this).parent().find('.info-tips').css({visibility: 'hidden'})
});
...
$.validator.setDefaults({
    ...
    errorPlacement: function (error, element) {
        element.parent().find('.info-tips').hide();
        error.appendTo(element.parent());
    },
    success: function (error, element) {
        error.remove();
        $(element).parent().find('.info-tips').show();
    }
});
...
jQuery.validator.addMethod("chsDash", function (value, element, param) {
    return this.optional(element) || /^[\u4e00-\u9fa5a-zA-Z0-9_-]+$/.test(value);
}, $.validator.format("只允许汉字、字母、数字和下划线_及破折号-"));
