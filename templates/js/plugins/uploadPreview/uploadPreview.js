...
var uploadPreview = function (setting) {
     ...
     */
    _self.Setting = {
        beforeCallback: _self.IsNull(setting.beforeCallback) ? _self.DefautlSetting.beforeCallback : setting.beforeCallback,
    ...
    _self.Bind = function () {
        document.getElementById(_self.Setting.UpBtn).onchange = function () {
            if (this.value) {
                if (!_self.Setting.beforeCallback(this.files[0])){
                    this.value='';
                    return false;
                }
